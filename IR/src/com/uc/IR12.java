package com.uc;// IR12.java CS6054 2015 Cheng
// Rocchio classification 
// Usage:  java IR12 adInvertedTf.txt isrInvertedTf.txt
...
// binary search
 ...
 void trainRocchio(){
  ...
  void classifyTestSamples(){  // Your code needed
 ...
 public static void main(String[] args){
   IR12 ir12 = new IR12();
   ir12.readInvertedIndexes("adInvertedTf.txt isrInvertedTf.txt".split(" "));
   ir12.normalizeVectors();
   ir12.combineTerms();
   ir12.selectTrainingSet();
   ir12.trainRocchio();
   ir12.applyRocchio();
 }
}